      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            _buildHeaderDivider(), // Divider between header and menus
  ...
  Widget _buildHeaderSection(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.sideMenuBackground, // light purple
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Icon(
              Icons.person,
              color: AppColors.primaryPurple, // Purple icon
              size: 60,
            ),
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: AppColors.primaryDarkBlue, // Dark blue text
                    ),
                  ),
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: AppColors.primaryPurple, // Purple oval background
  ...
  Widget _buildMenuItem({
    ...
    return Container(
      ...
      child: ListTile(
        leading: Icon(
          icon,
          color: AppColors.sideMenuIcon, // Purple icon
          size: 24,
        ),
        title: Text(
          text,
