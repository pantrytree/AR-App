...
/// ViewModel for managing the "My Projects" page.
/// This acts as the middle layer between the UI (the page) and the backend.
/// Currently uses placeholders and does not connect to any real backend.
///
